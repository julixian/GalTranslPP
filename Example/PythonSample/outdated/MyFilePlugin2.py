...
def unload():
    try:
        if runUnloadFunc and pythonTranslator.m_transEngine != gpp.ShowNormal:
            ...
            with open(pythonTranslator.m_projectDir / "NameTable.toml", 'rb') as f:
            ...
            with open(pythonTranslator.m_projectDir / "NameTable_cnjp.json", 'w', encoding='utf-8') as f:
                json.dump(newNameTable, f, ensure_ascii=False, indent=2)
            shutil.copy(pythonTranslator.m_projectDir / "NameTable_cnjp.json", gamePath / "name_proc")
